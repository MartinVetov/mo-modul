...
<p class="muted small">„Дублирай“ отваря нов анализ със същия предмет и същите отметки по
   компетентностите – остава да изберете паралелката и да въведете оценките. При РПП се показват само паралелките,
   за които предметът е зададен по клас и професия/специалност.</p>
<?php endif; ?>
<?php footer_html(); ?>
